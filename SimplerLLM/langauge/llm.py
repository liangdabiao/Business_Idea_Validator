...
class LLM:
    def __init__(self, provider=LLMProvider.OPENAI, model_name="gpt-4.1", temperature=0.7,top_p=1.0):
    ...
    @staticmethod
    def create(provider=LLMProvider.OPENAI, model_name="gpt-4.1", temperature=0.7,top_p=1.0):
